...
{
	partial class FormAddSliceToNodesLocation
	{
		/// <summary>
		...
		{
			this.control = new PlanetLab.Controls.ControlAddSliceToNodesLocation();
			this.SuspendLayout();
			// 
			// control
			// 
		...
		private Controls.ControlAddSliceToNodesLocation control;
