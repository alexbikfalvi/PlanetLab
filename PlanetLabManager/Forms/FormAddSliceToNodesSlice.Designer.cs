...
{
	partial class FormAddSliceToNodesSlice
	{
		/// <summary>
		...
		{
			this.control = new PlanetLab.Controls.ControlAddSliceToNodesSlice();
			this.SuspendLayout();
			// 
			// control
			// 
		...
		private Controls.ControlAddSliceToNodesSlice control;
